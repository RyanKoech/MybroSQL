      ...
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className="flex md:order-2">
          ...
          <a
            ...
            type="button"
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 sm:px-5 py-2.5 text-center mr-1 sm:mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            target="_blank"
          >
            Buy Me Coffee☕
          </a>
